...
if (Helper::isAdmin()): ?>
    ...
    <form method="POST" action="">
        <div class="container">
            ...
            <span class="error">
                <?php Helper::FormIcorrectInputMessage("price"); ?>
            </span>
            </br></br>
            ...
            <span class="error">
                <?php Helper::FormIcorrectInputMessage("qty"); ?>
            </span>
            </br></br>
            Опис:
            <p><textarea rows="5" cols="62" name="description"><?= $product["description"] ?></textarea></p>
            <span class="error">
                <?= Helper::isEmpty('product')[5]; ?>
            </span>
            </br></br>
