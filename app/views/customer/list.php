...
?>
    ...
    <?php		
		...
		echo Helper::simpleLink('/customer/edit', 'Редагувати', array($id_column_name=>$customer[$id_column_name]))." ";
		echo '<span class="glyphicon glyphicon-trash"></span>'." ";				
		echo Helper::simpleLink('/customer/delete', 'Видалити', array($id_column_name=>$customer[$id_column_name]));
		}
	?>    
	</div>
<?php endforeach; ?>
